...
(0, config_1.extendProvider)(async (provider, config, network) => {
    const { createLedgerProvider } = await Promise.resolve().then(() => __importStar(require("./internal/create-ledger-provider")));
