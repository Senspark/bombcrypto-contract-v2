...
exports.getFiltersForMessage = exports.isEIP712Message = exports.ledgerService = void 0;
...
Object.defineProperty(exports, "isEIP712Message", { enumerable: true, get: function () { return EIP712_1.isEIP712Message; } });
Object.defineProperty(exports, "getFiltersForMessage", { enumerable: true, get: function () { return EIP712_1.getFiltersForMessage; } });
    ...
    provideDomainName(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const payload = Buffer.concat([
                Buffer.from((0, utils_1.intAsHexBytes)(buffer.length, 2), "hex"),
                buffer,
            ]);
