...
const EIP712_utils_1 = require("./EIP712.utils");
/**
...
const makeRecursiveFieldStructImplem = (transport, types, filters) => {
    ...
    const recursiveFieldStructImplem = (destructedType, data, path = "") => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const isCustomType = !EIP712_utils_1.EIP712_TYPE_PROPERTIES[((_b = typeDescription === null || typeDescription === void 0 ? void 0 : typeDescription.name) === null || _b === void 0 ? void 0 : _b.toUpperCase()) || ""];
        if (Array.isArray(data) && typeof currSize !== "undefined") {
            ...
            for (const [fieldName, fieldValue] of Object.entries(data)) {
                ...
                if (fieldType) {
                    yield recursiveFieldStructImplem((0, EIP712_utils_1.destructTypeFromString)(fieldType), fieldValue, `${path}.${fieldName}`);
                }
            }
        }
        else {
...
const sendStructImplem = (transport, structImplem) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (structType === "field") {
        ...
        const encodedData = (_a = EIP712_utils_1.EIP712_TYPE_ENCODERS[type.toUpperCase()]) === null || _a === void 0 ? void 0 : _a.call(EIP712_utils_1.EIP712_TYPE_ENCODERS, rawData, sizeInBits);
        if (encodedData) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (type) {
            ...
            case "contractName": {
                ...
                const displayNameLengthBuffer = Buffer.from((0, utils_1.intAsHexBytes)(displayName.length, 1), "hex");
                ...
                const sigLengthBuffer = Buffer.from((0, utils_1.intAsHexBytes)(sig.length / 2, 1), "hex");
 ...
 * @returns {Promise}
 */
const signEIP712Message = (transport, path, jsonMessage, fullImplem = false, loadConfig) => __awaiter(void 0, void 0, void 0, function* () {
    let APDU_FIELDS;
    (function (APDU_FIELDS) {
        APDU_FIELDS[APDU_FIELDS["CLA"] = 224] = "CLA";
    ...
    const { cryptoassetsBaseURL } = (0, loadConfig_1.getLoadConfig)(loadConfig);
    // Types are sorted by alphabetical order in order to get the same schema hash no matter the JSON format
    const types = (0, EIP712_utils_1.sortObjectAlphabetically)(unsortedTypes);
    const filters = yield (0, EIP712_utils_1.getFiltersForMessage)(jsonMessage, cryptoassetsBaseURL);
    ...
    for (const [typeName, entries] of typeEntries) {
        ...
        for (const { name, type } of entries) {
            const typeEntryBuffer = (0, EIP712_utils_1.makeTypeEntryStructBuffer)({ name, type });
            yield sendStructDef(transport, {
                structType: "field",
    ...
    for (const { name, type } of domainTypeFields) {
        ...
        yield recursiveFieldStructImplem((0, EIP712_utils_1.destructTypeFromString)(type), domainFieldValue);
    }
    if (filters) {
    ...
    for (const { name, type } of primaryTypeFields) {
        ...
        yield recursiveFieldStructImplem((0, EIP712_utils_1.destructTypeFromString)(type), primaryTypeValue, name);
    }
...
Object.defineProperty(exports, "isEIP712Message", { enumerable: true, get: function () { return EIP712_utils_2.isEIP712Message; } });
Object.defineProperty(exports, "getFiltersForMessage", { enumerable: true, get: function () { return EIP712_utils_2.getFiltersForMessage; } });
