...
exports.getFiltersForMessage = exports.getSchemaHashForMessage = exports.sortObjectAlphabetically = exports.isEIP712Message = exports.makeTypeEntryStructBuffer = exports.constructTypeDescByteString = exports.destructTypeFromString = exports.EIP712_TYPE_ENCODERS = exports.EIP712_TYPE_PROPERTIES = void 0;
...
const makeTypeEntryStructBuffer = ({ name, type, }) => {
    ...
    const typeProperties = exports.EIP712_TYPE_PROPERTIES[((_a = typeDescription === null || typeDescription === void 0 ? void 0 : typeDescription.name) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || ""] ||
    ...
    const typeDescData = (0, exports.constructTypeDescByteString)(isTypeAnArray, typeSizeInBits, typeKey);
    const bufferArray = [Buffer.from(typeDescData, "hex")];
    if (typeProperties === exports.EIP712_TYPE_PROPERTIES.CUSTOM) {
        bufferArray.push(Buffer.from((0, utils_1.intAsHexBytes)((_c = (_b = typeDescription === null || typeDescription === void 0 ? void 0 : typeDescription.name) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0, 1), "hex"));
...
const getFiltersForMessage = (message, remoteCryptoAssetsListURI) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (remoteCryptoAssetsListURI) {
            const { data: dynamicCAL } = yield axios_1.default.get(`${remoteCryptoAssetsListURI}/eip712.json`);
