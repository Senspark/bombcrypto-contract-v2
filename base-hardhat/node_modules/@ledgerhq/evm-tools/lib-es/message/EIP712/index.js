 ...
 */
export const getEIP712FieldsDisplayedOnNano = (messageData, remoteCryptoAssetsListURI = getEnv("DYNAMIC_CAL_BASE_URL")) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filters = yield getFiltersForMessage(messageData, remoteCryptoAssetsListURI);
    if (!filters) {
        ...
        displayedInfos.push({
            label: "Message hash",
            value: ethers.utils._TypedDataEncoder.hashStruct(messageData.primaryType, otherTypes, messageData.message),
        });
